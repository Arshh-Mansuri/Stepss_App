...
class ShieldConfigurationExtension: ShieldConfigurationDataSource {
    ...
    private nonisolated func createShieldConfig(title: String) -> ShieldConfiguration {
        ...
        return ShieldConfiguration(
            ...
            title: ShieldConfiguration.Label(text: title, color: UIColor(hex: "#F0EFFE")),
            subtitle: ShieldConfiguration.Label(text: subtitleText, color: UIColor(hex: "#9B95D4")),
            ...
            secondaryButtonLabel: ShieldConfiguration.Label(text: "Go back", color: UIColor(hex: "#9B95D4"))
        )
    }
